      ...
      <div class="main-container">
        ...
        <p id="who-i-am">WHO I AM</p>
          <h5>
            ...
            <span id="i-am">
              An emerging full-stack developer based in Dallas TX, looking
              to integrate and grow my experience in the technological world
            </span>
          </h5>

          <div class="background-container">
            <p id="background">
              My background is in both business and IT, with a degree
              <br />
              in Computer science and 2+ years experience
              <br />
              ...
              applications
              <br />
              and possess an extensive knowledge in a wide array of front-end
              <br />
              programming languages such as Javascript, Typescript, HTML,
              <br />
              CSS and object-oriented programming such as Java, C# and C++.
              <br />I am regarded for my work ethic and conflict resolution, and
              I thrive
              <br />
              in working in a fast-paced, high-tech environment with
              <br />
              cross-functional teams using Agile methodology.
            </p>

            <p id="background2">
              I'm driven by my desire for usability and efficiency, starting
              with a<br />
        ...
        <div>
          <article>
            <ul class="exp-paragraphs">
              ...
              <li>
                Created and compiled comprehensive financial reports to reflect
                company's spending
              </li>
              <li>
        ...
        <div>
          <article>
            <ul class="exp-paragraphs">
              ...
              <li>
                Reconciled job descriptions with position control to ensure that
                there is a job
                <br />
        ...
        <div>
          <article>
            <ul class="exp-paragraphs">
              ...
              <li>
                Provided direct administrative support to multiple IT project
                managers and team leads,
                <br />
                including calendar management, scheduling, and expense reports
              </li>
              <li>
                Provided PowerPoint presentations and website orientations for
                new employees, which included subjects related
                <br />
                to onboarding and admission processes.{" "}
              </li>
              <li>
                Traversed and worked between the business and IT spectrum where
                I used database queries
                <br />
              ...
              <li>
                Tracking and providing guidance to employees and management on
                timesheets, leaves, and payroll.
              </li>
              <li>
